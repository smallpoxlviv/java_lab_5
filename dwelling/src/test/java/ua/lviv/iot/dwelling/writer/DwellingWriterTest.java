...
import ua.lviv.iot.dwelling.model.Flat;
...
class DwellingWriterTest {
    ...
    String comparableText = "areaInSquareMeters;priceInUSD;location;SoundInsulationOfWalls;district;allRoomsCount;balconyCount;kitchenCount;restroomCount;floorCount;windowsCount;poolAvability;garageAvability;numberOfFloor;neighboringApartmentsOnFloorCount;areaOfLandInSquareMeters;entranceDoorCount;otherBuildingsInArea\r\n" + 
            "45.2;55000.0;49.838883, 24.027453;null;Syhivski;0;0;0;0;0;0;false;false;;;0.0;0;false\r\n" + 
            "18.5;46000.0;49.825672, 23.954481;null;Frankivski;0;2;0;0;0;0;false;false;0;0\r\n" + 
            "";
    ...
    public void setUp() {
        ...
        dwellings.add(new Flat(18.5, 46000, new Location(49.825672, 23.954481), "Frankivski", 2));
    }
